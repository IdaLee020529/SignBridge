    ...
    return (
        <>
            <div className={style.feedback_header_container}>
                ...
                <p className={style.feedback_subheading}>
                    {t("feedback_subheading")}
                </p>
            </div>
            <div className={style.feedback_container}>
                ...
                <div className={style.feedback_box}>
                    <form id="feedbackForm" onSubmit={handleSubmit}>
                        <legend className={style.feedback_legend}>
                            {t("personal_details")}
                        </legend>
                            ...
                            <div className={style.feedback_row}>
                                <div className={style.feedback_input}>
                                    ...
                                    {formErrors.firstName.length > 0 && (
                                        <div className={style.feedback_error}>
                            ...
                            <div className={style.feedback_row}>
                                ...
                                >
                                    ...
                                    <div className={style.select_wrapper}>
                                        ...
                                        >
                                            {/* dropdown */}
                                            <option value="Whole Website">
                                                {t("whole_website")}
                                            </option>
                                            <option value="Game 1">
                                                {t("game1_guess_the_word")}
                                            </option>
                                            <option value="Game 2">
                                                {t("game2_do_the_sign")}
                                            </option>
                                ...
                                <div className={style.feedback_input2}>
                                    ...
                                    <div className={style.rating_emojis}>
                                        <RatingEmoji
                                            type="radio"
                                            name="experience"
                                            className="super_happy"
                                            id="super-happy"
                                            value={5}
                                            onChange={handleFormChange}
                                            checked={formData.experience === 5}
                                        />
                                        <RatingEmoji
                                            type="radio"
                                            name="experience"
                                ...
                                <div className={style.feedback_input2}>
                                    ...
                                    <div className={style.rating_emojis}>
                                        <RatingEmoji
                                            ...
                                            value={5}
                                            onChange={handleFormChange}
                                            checked={formData.recommended === 5}
                                        />
                                        <RatingEmoji
                                            type="radio"
                                            name="recommended"
                            ...
                            <div className={style.feedback_row}>
                                <div className={style.feedback_input}>
                                    <label htmlFor="question1">
                                        {
                                            questionMapping[
                                                formData.fcategory as keyof typeof questionMapping
                                            ]?.question1
                                        }
                                    </label>
                                    <textarea
