                    ...
                    <Card key={index} className={style.Cards}>
                        <div className={style.CardContent}>
                            <Icon
                                ...
                                style={{ color: category.color, padding: "10px", borderRadius: "10px", backgroundColor: category.backgroundColor}}
                            />
                        ...
                        <Doughnut
                            ...
                            plugins={[{
                                ...
                                beforeDraw: (chart, args, pluginOptions) => {
                                    ...
                                    const secondTextX = Math.round((width - ctx.measureText(secondText).width) / 2);
